...
export const translations = {
  en: {
    ...
    onboardNewMember: "Onboard New Member",
    memberMobile: "Mobile Number",
    investedAmountPkr: "Invested Amount (PKR)",
    pictureUrlOptional: "Picture URL (optional)",
    onboardMember: "Onboard Member",
    onboardSuccess: "Member onboarded successfully.",
    onboardFailed: "Failed to onboard member.",
    adminReceipts: "Receipt Generator",
    selectType: "Select type",
    selectRecord: "Select record",
    payout: "Payout",
    agentOnlyArea: "This area is for agents only.",
    myMembers: "My Members",
    noMembers: "No members onboarded yet.",
  ...
  ur: {
    ...
    receiptType: "رسید کی قسم",
    receiptLanguage: "رسید کی زبان",
    ...
    onboardNewMember: "نیا رکن شامل کریں",
    memberMobile: "موبائل نمبر",
    investedAmountPkr: "سرمایہ کاری کی رقم (پی کے آر)",
    pictureUrlOptional: "تصویر کا لنک (اختیاری)",
    onboardMember: "رکن شامل کریں",
    onboardSuccess: "رکن کامیابی سے شامل ہو گیا۔",
    onboardFailed: "رکن شامل کرنے میں ناکامی۔",
    adminReceipts: "رسید جنریٹر",
    selectType: "قسم منتخب کریں",
    selectRecord: "ریکارڈ منتخب کریں",
    payout: "ادائیگی",
    agentOnlyArea: "یہ حصہ صرف ایجنٹوں کے لیے ہے۔",
    myMembers: "میرے ارکان",
    noMembers: "ابھی کوئی رکن شامل نہیں۔",
    ...
    notificationsError: "اطلاعات لوڈ کرنے میں ناکامی۔",
    loadingNotifications: "اطلاعات لوڈ ہو رہی ہیں…",
    markReadError: "پڑھا ہوا نشان زد نہیں ہو سکا۔ دوبارہ کوشش کریں۔",
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = (key: TranslationKey) => {
    ...
    >;
    const en = translations.en as Record<
      string,
